...
def test_registration_form():
    ...
    app.result_registered_user_dialog.table_row(6, value='Computer Science, English')
    app.result_registered_user_dialog.table_row(7, value='Sports, Reading, Music')
    ...
    app.result_registered_user_dialog.table_row(10, value='NCR Delhi')